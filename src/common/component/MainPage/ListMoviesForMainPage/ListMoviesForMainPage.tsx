...
const handleLike=(e)=>{
        !isLike?
        setIsLike(true) : setIsLike(false)
    ...
    const result=data.find((f)=>f.id===idLike)
    const newFilm={id:result.id,title: result.title,backdrop_path: result.backdrop_path,vote_average: result.vote_average};
                           ...
                           href="src/common/component/MainPage/ListMoviesForMainPage/ListMoviesForMainPage">
                            ...
                            <button id={el.id} onClick={handleLike}  className={ s.like}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"
                                     focusable="false" className={!isLike ? s.active:s.favoriteIcon}>
                                    <path
